...
class Ui_linear_two_points_dialog(object):
    def setupUi(self, linear_two_points_dialog):
        ...
        self.x0LineEdit = DotLineEdit(linear_two_points_dialog)
        ...
        self.y0LineEdit = DotLineEdit(linear_two_points_dialog)
        ...
        self.x1LineEdit = DotLineEdit(linear_two_points_dialog)
        ...
        self.y1LineEdit = DotLineEdit(linear_two_points_dialog)
        ...
        self.aLineEdit.setGeometry(QRect(120, 100, 131, 21))
        ...
        self.bLineEdit.setGeometry(QRect(120, 130, 131, 21))
