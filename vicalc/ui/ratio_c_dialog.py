...
class Ui_ratio_c_dialog(object):
    def setupUi(self, ratio_c_dialog):
        if not ratio_c_dialog.objectName():
            ratio_c_dialog.setObjectName(u"ratio_c_dialog")
        ratio_c_dialog.resize(340, 240)
        self.buttonBox = QDialogButtonBox(ratio_c_dialog)
        self.buttonBox.setObjectName(u"buttonBox")
        self.buttonBox.setGeometry(QRect(10, 200, 321, 32))
        self.buttonBox.setOrientation(Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QDialogButtonBox.StandardButton.Cancel|QDialogButtonBox.StandardButton.Ok)
        self.frame = QFrame(ratio_c_dialog)
        ...
        self.label_2.raise_()
        self.label_3 = QLabel(ratio_c_dialog)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(170, 40, 49, 16))
        self.frame_2 = QFrame(ratio_c_dialog)
        ...
        self.label_4.setGeometry(QRect(0, 52, 49, 16))
        self.label_5 = QLabel(self.frame_2)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(50, 10, 49, 16))
        self.label_5.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.xLineEdit = QLineEdit(ratio_c_dialog)
        self.xLineEdit.setObjectName(u"xLineEdit")
        self.xLineEdit.setGeometry(QRect(40, 148, 113, 21))
        self.label_6 = QLabel(ratio_c_dialog)
        ...
        QWidget.setTabOrder(self.bLineEdit, self.dLineEdit)
        QWidget.setTabOrder(self.dLineEdit, self.xLineEdit)

        self.retranslateUi(ratio_c_dialog)
        self.buttonBox.accepted.connect(ratio_c_dialog.accept)
        self.buttonBox.rejected.connect(ratio_c_dialog.reject)

        QMetaObject.connectSlotsByName(ratio_c_dialog)
    # setupUi

    def retranslateUi(self, ratio_c_dialog):
        ratio_c_dialog.setWindowTitle(QCoreApplication.translate("ratio_c_dialog", u"Ratio Calculation: Unknown C", None))
        self.label_2.setText(QCoreApplication.translate("ratio_c_dialog", u"b", None))
        self.label.setText(QCoreApplication.translate("ratio_c_dialog", u"a", None))
        self.label_3.setText(QCoreApplication.translate("ratio_c_dialog", u"=", None))
        self.label_4.setText(QCoreApplication.translate("ratio_c_dialog", u"d", None))
        self.label_5.setText(QCoreApplication.translate("ratio_c_dialog", u"c", None))
        self.label_6.setText(QCoreApplication.translate("ratio_c_dialog", u"c", None))
    # retranslateUi
